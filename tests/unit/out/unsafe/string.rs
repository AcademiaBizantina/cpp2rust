...
unsafe fn main_0() -> i32 {
    ...
    let mut string: Vec<u8> = std::slice::from_raw_parts(arr.as_mut_ptr(), 3_u64 as usize)
        .to_vec()
        .iter()
        .copied()
        .chain(std::iter::once(0))
